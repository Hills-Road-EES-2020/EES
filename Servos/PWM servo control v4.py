# WG Created: 17/12/19 Modified:17/12/19
# EES servo conto
...
pin_1_down_angle = down_angle_default
pin_1_up_angle = up_angle_default
pin_2_down_angle = down_angle_default
pin_2_up_angle = up_angle_default
pin_3_down_angle = down_angle_default
pin_3_up_angle = up_angle_default
pin_4_down_angle = down_angle_default
pin_4_up_angle = up_angle_default
pin_5_down_angle = down_angle_default
pin_5_up_angle = up_angle_default
pin_6_down_angle = down_angle_default
pin_6_up_angle = up_angle_default
...
def servo(pin_number, direction):
    ...
    if direction == down: # list of conditional statements to set the correct angle for the servo
        if pin_number == 1:
            angle = pin_1_down_angle
        elif pin_number == 2:
            angle = pin_2_down_angle
        elif pin_number == 3:
            angle = pin_3_down_angle
        elif pin_number == 4:
            angle = pin_4_down_angle
        elif pin_number == 5:
            angle = pin_5_down_angle
        elif pin_number == 6:
            angle = pin_6_down_angle
        else:
            angle = down_angle_default
    elif direction == up:
        if pin_number == 1:
            angle = pin_1_up_angle
        elif pin_number == 2:
            angle = pin_2_up_angle
        elif pin_number == 3:
            angle = pin_3_up_angle
        elif pin_number == 4:
            angle = pin_4_up_angle
        elif pin_number == 5:
            angle = pin_5_up_angle
        elif pin_number == 6:
            angle = pin_6_up_angle
        else:
